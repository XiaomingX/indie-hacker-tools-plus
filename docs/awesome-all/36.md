...
- [SIGIR](https://sigir.org/) - ACM SIGIR International Conference on Research and Development in Information Retrieval  
  信息检索领域顶会，每年1次。推荐与检索深度交叉（如召回、排序、会话式交互），**侧重“检索技术在推荐中的落地”**，2025年重点方向包括生成式推荐、LLM驱动的检索-推荐融合、多模态推荐等，会议同期设“工业界论坛”展示百度、美团等企业的最新实践[4]。
...
- [WWW](https://www2025.thewebconf.org/) - The Web Conference（原WWW Conference）  
...
- SIGIR 2025 最新论文示例（反映大模型+推荐趋势）[4]：  
