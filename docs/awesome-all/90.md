...
- [**Notion AI 5.0**](https://www.notion.so/product/ai) - 在Notion中直接提问，几秒内找到答案，还能帮你写作和头脑风暴，无需切换浏览器标签页。  
- [**Murf AI**](https://murf.ai/) - 使用最逼真的AI语音生成高质量配音。  
- [**MeetGeek**](https://get.meetgeek.ai/zmrnb5xlyfs9) - 一款AI会议助手，可自动录制视频、转录、总结会议并提取关键要点。  
- [**Kimi**](https://kimi.com) - 国内创新型AI，特别擅长中文自然语言处理与对话生成，定位于高效办公助手。  
...
- **[GPT-5系列](https://openai.com/gpt-5)** - 2025年8月发布的统一架构模型，支持272K输入tokens和128K输出tokens，推理能力显著提升。其中GPT-5-Codex专为编程场景优化，可独立完成复杂代码重构任务，在SWE-bench Verified基准测试中达到74.5%的准确率。
- **[Claude 4系列](https://claude.ai/)** - Anthropic推出的"世界最佳编程模型"，在SWE-bench Verified基准测试中达到74.5%的成绩，支持20万token上下文窗口。
- **[Llama 4系列](https://ai.meta.com/llama/)** - Meta采用专家混合(MoE)架构的新一代模型，Llama 4 Scout支持1000万token上下文窗口，创下行业记录。
- **[Gemini 2.5 Pro](https://gemini.google.com/)** - Google推出的多模态模型，内置"思考"功能，在LMArena排行榜上位列第一。
- **[Qwen3系列](https://modelscope.cn/models/qwen/Qwen-7B-Chat/summary)** - 阿里巴巴推出的混合推理模型，支持256K上下文窗口，在中文基准测试中表现优异。
- **[龙软时空大模型1.0](https://loongmodel.com)** - 首个工程领域时空大模型，支持矢量图形处理和多模态时空数据理解，已应用于矿山智能管控。
...
- **[Claude-instant 4](https://claude.ai/)** - Anthropic推出的轻量版模型，支持实时交互与长文档分析。
...
6. **ShareGPT**：分享你的ChatGPT对话，探索他人分享的内容。[点击访问](https://sharegpt.com/)  
7. **Merlin**：适用于所有网站的ChatGPT Plus扩展。[点击访问](https://merlin.foyer.work/)  
8. **ChatGPT Writer**：用ChatGPT生成完整的邮件和信息。[点击访问](https://chatgptwriter.ai/)  
9. **ChatGPT for Jupyter**：在Jupyter Notebook和Lab中添加多种ChatGPT功能。[点击访问](https://github.com/TiesdeKok/chat-gpt-jupyter-extension)  
10. **editGPT**：轻松校对、编辑并跟踪内容修改。[点击访问](https://www.editgpt.app/)  
11. **Chatbot UI**：开源的ChatGPT用户界面。[点击访问](https://www.chatbotui.com/)  

### 提高效率工具

1. **Mem**：首个个性化的AI工作区，助你提升创造力、自动处理琐事。[点击访问](https://mem.ai/)  
2. **Taskade**：集任务管理、团队协作、工作流自动化于一体的AI工具。[点击访问](https://www.taskade.com/)  
3. **Nekton AI**：用AI自动化工作流程，只需用简单语言描述步骤。[点击访问](https://nekton.ai)  
4. **aiPDF**：智能文档助手，为你总结长PDF的内容。[点击访问](https://aipdf.ai)  
5. **Pieces**：开发者专属的AI效率工具，支持代码片段管理和实时协作。[点击访问](https://pieces.app)  

### 求职与职业发展

- **[JobLeap.cn](https://jobleap.cn)** - 最好的模拟面试和简历优化AI产品，提供基于真实岗位需求的模拟面试、大数据预测的高频面试题、智能简历优化和精准职位推荐。配套微信小程序“Boli职业助手”支持随时随地进行求职准备。  
...
- **[豆包](https://doubao.com)**：字节跳动旗下的多模态智能助手，支持文本理解与视觉生成深度融合，可生成8K分辨率图片，在医疗、教育等专业领域回答准确率达95%。  
- **[Nano Banana](https://nano-banana.com)**：Google的免费图像编辑工具，支持文本引导的语义级编辑，如更换星空背景或修复图像。  
- **[Qwen-Image-Edit](https://huggingface.co/qwen/Qwen-Image-Edit)**：开源的高精度图像编辑模型，支持1024x1024分辨率输出，可移除或添加特定元素。  

---

### 开发者工具

- **[Cursor](https://www.cursor.so)**：多模型协作的开发工具，支持“自然语言→代码→文档”全流程转换，代码生成准确率达83%。  
- **[Claude Code](https://claude.ai/code)**：Anthropic推出的专业编程助手，深度集成GitHub Actions和VS Code，支持并行工具调用和代码执行。  
- **[GraphRAG](https://github.com/microsoft/GraphRAG)**：微软的图基检索工具，可从文本构建知识图谱，提升复杂查询召回率50%。  
