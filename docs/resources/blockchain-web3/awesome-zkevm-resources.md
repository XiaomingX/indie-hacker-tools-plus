...
| [以Rollup为核心的以太坊路线图](https://ethereum-magicians.org/t/a-rollup-centric-ethereum-roadmap/4698) | Vitalik提出的以太坊长期扩容战略，明确ZK-Rollup将逐步成为Layer2的主导方案（截至2026年已基本落地）。 |
...
| **Polygon Zero** | 基于Plonky2协议，主打“超快速证明生成”，2026年逐步合并入Polygon zkEVM生态 | - [Plonky2协议库](https://github.com/mir-protocol/plonky2)（zk领域最快的证明库之一） |
...
| **Miden** | 基于“Miden VM”，主打隐私计算，2026年处于测试网阶段 | - [Miden VM代码仓库](https://github.com/0xPolygonMiden/miden-vm) |
...
## 补充说明
1. **资源时效性**：本文档基于2026年5月的技术现状整理，zkEVM领域迭代极快，建议通过项目官网（如Scroll、zkSync）获取最新动态。  
