...
| [通过 Cloudflare 页面函数向 Telegram 发消息](https://liujiacai.net/blog/2026/05/07/telegram-bot-functions/) | 利用页面函数作为 GitHub Webhook 地址，将事件转发到 Telegram 频道。 | | 有效中 |
| [使用Cloudflare Workers制作博客AI摘要](https://mabbs.github.io/2026/07/03/ai-summary.html) | 使用 Cloudflare Workers + Workers AI + D1 数据库实现博客 AI 摘要。 | | 有效中 |
