...
* [Darknet](https://github.com/pjreddie/darknet) - Darknet 是一个开源神经网络框架，使用 C 和 CUDA 编写，支持 CPU 和 GPU 计算，安装简单且运行快速。
* [Recommender](https://github.com/GHamrouni/Recommender) - 一个基于 C 语言的产品推荐库，使用协同过滤（CF）技术。
* [Hybrid Recommender System](https://github.com/SeniorSA/hybrid-rs-trainner) - 基于 scikit-learn 算法的混合推荐系统。**[已废弃]**
* [neonrvm](https://github.com/siavashserver/neonrvm) - neonrvm 是一个基于 RVM 技术的开源机器学习库，使用 C 语言编写，并提供 Python 绑定。
* [cONNXr](https://github.com/alrevuelta/cONNXr) - 一个纯 C（99）编写的 `ONNX` 运行时，专为小型嵌入式设备设计，支持各种机器学习框架的推理，安装简便，兼容旧设备。
* [libonnx](https://github.com/xboot/libonnx) - 一个轻量级、便携的纯 C99 编写的 onnx 推理引擎，支持硬件加速，适用于嵌入式设备。

<a name="c-computer-vision"></a>
### 计算机视觉相关库

#### C语言与通用计算机视觉库
- **[CCV](https://github.com/liuliu/ccv)**：现代计算机视觉库，支持C语言，并提供缓存和核心功能。
- **[VLFeat](http://www.vlfeat.org/)**：开源计算机视觉算法库，提供Matlab工具箱。

#### C++计算机视觉库
- **[DLib](http://dlib.net/imaging.html)**：提供C++和Python接口，用于人脸检测和训练通用物体检测器。
- **[OpenCV](https://opencv.org)**：广泛使用的计算机视觉库，支持C++、C、Python、Java和Matlab，跨平台支持Windows、Linux、Android和Mac OS。
- **[VIGRA](https://github.com/ukoethe/vigra)**：跨平台C++计算机视觉与机器学习库，支持多维数据的处理，并有Python绑定。
- **[OpenPose](https://github.com/CMU-Perceptual-Computing-Lab/openpose)**：实时多人体关键点检测库，支持人体、面部、手部和足部估计。

### C++通用机器学习库

- **[Speedster](https://github.com/nebuly-ai/nebullvm/tree/main/apps/accelerate/speedster)**：自动应用最先进的优化技术，提升硬件推理速度。
- **[Caffe](https://github.com/BVLC/caffe)**：专为深度学习设计的框架，注重清晰性、可读性和速度。
- **[CatBoost](https://github.com/catboost/catboost)**：支持类别特征的梯度提升决策树库，易于安装，支持CPU和GPU（包括多GPU）计算。
- **[LightGBM](https://github.com/Microsoft/LightGBM)**：微软开发的快速、分布式、高性能梯度提升框架，广泛用于排名、分类等任务。
- **[XGBoost](https://github.com/dmlc/xgboost)**：广泛使用的并行优化的梯度提升库，适用于各种机器学习任务。
- **[DeepDetect](https://github.com/jolibrain/deepdetect)**：机器学习API和服务器，易于集成和应用。
- **[mlpack](https://www.mlpack.org/)**：高效的C++机器学习库，适用于大规模机器学习任务。
- **[PyCaret](https://github.com/pycaret/pycaret)**：低代码Python机器学习库，自动化机器学习工作流。

### 其他工具和平台

- **[Shogun](https://github.com/shogun-toolbox/shogun)**：开源机器学习工具箱，提供丰富的机器学习算法。
- **[Featuretools](https://github.com/featuretools/featuretools)**：自动化特征工程库，帮助将事务型和关系型数据集转化为机器学习特征矩阵。
- **[Polyaxon](https://github.com/polyaxon/polyaxon)**：可复现和可扩展的机器学习平台，支持深度学习。

### 自然语言处理 (NLP)
* [BLLIP Parser](https://github.com/BLLIP/bllip-parser) - BLLIP自然语言解析器（Charniak-Johnson解析器）。
* [colibri-core](https://github.com/proycon/colibri-core) - C++库及命令行工具，用于高效处理基本语言构造，如n-gram和skipgram。
* [frog](https://github.com/LanguageMachines/frog) - 适用于荷兰语的内存型NLP工具集，包含词性标注、词形还原、依存句法分析、命名实体识别等功能。
* [libfolia](https://github.com/LanguageMachines/libfolia) - C++库，用于处理[FoLiA格式](https://proycon.github.io/folia/)。
* [MeTA](https://github.com/meta-toolkit/meta) - C++数据科学工具包，用于挖掘大规模文本数据。
* [MIT Information Extraction Toolkit](https://github.com/mit-nlp/MITIE) - 提供命名实体识别和关系抽取的C、C++、Python工具。
* [ucto](https://github.com/LanguageMachines/ucto) - 支持Unicode的正则表达式分词器，支持多种语言及FoLiA格式。

### 语音识别
* [Kaldi](https://github.com/kaldi-asr/kaldi) - C++编写的语音识别工具包，适用于语音识别研究。

### 强化学习
* [RLtools](https://github.com/rl-tools/rl-tools) - 纯C++编写的高效深度强化学习库，支持连续控制，并提供Python绑定。

### 手势识别
* [grt](https://github.com/nickgillian/grt) - 跨平台开源C++机器学习库，专为实时手势识别设计。

### 自然语言处理（NLP）

- **[BLLIP Parser](https://github.com/BLLIP/bllip-parser)** - BLLIP自然语言解析器（Charniak-Johnson解析器）。
- **[colibri-core](https://github.com/proycon/colibri-core)** - C++库及命令行工具，支持高效地提取和处理基本语言构造（如n-grams、skipgrams）。
- **[frog](https://github.com/LanguageMachines/frog)** - 适用于荷兰语的内存型NLP套件：词性标注器、词形还原、依存句法分析、命名实体识别等。
- **[libfolia](https://github.com/LanguageMachines/libfolia)** - 支持FoLiA格式的C++库。
- **[MeTA](https://github.com/meta-toolkit/meta)** - C++数据科学工具包，用于大规模文本数据挖掘。
- **[MIT Information Extraction Toolkit](https://github.com/mit-nlp/MITIE)** - 用于命名实体识别和关系抽取的C、C++和Python工具。
- **[ucto](https://github.com/LanguageMachines/ucto)** - Unicode感知的基于正则表达式的分词器，支持多种语言和FoLiA格式。

### 语音识别

- **[Kaldi](https://github.com/kaldi-asr/kaldi)** - 一个开源的C++语音识别工具包，适用于语音识别研究。

### 强化学习

- **[RLtools](https://github.com/rl-tools/rl-tools)** - 用于连续控制的最快深度强化学习库，纯C++实现（也有Python绑定）。

### 常见编程语言与机器学习

#### Go 语言

- **[Cybertron](https://github.com/nlpodyssey/cybertron)** - Go实现的Transformer自然语言处理工具包。
- **[snowball](https://github.com/tebeka/snowball)** - Go语言实现的Snowball词干提取算法。
- **[word-embedding](https://github.com/ynqa/word-embedding)** - Go语言实现的word2vec和GloVe词向量。
- **[Spago](https://github.com/nlpodyssey/spago)** - Go语言的自包含机器学习与自然语言处理库。
- **[golearn](https://github.com/sjwhitworth/golearn)** - Go语言的机器学习库。
- **[gorgonia](https://github.com/gorgonia/gorgonia)** - Go语言的深度学习库，类似TensorFlow。
- **[gorse](https://github.com/zhenghaoz/gorse)** - 用协同过滤算法实现的Go语言推荐系统后端。

### Go相关库

#### 空间分析与几何处理
* [go-geom](https://github.com/twpayne/go-geom) - Go语言几何处理库。
* [gogeo](https://github.com/golang/geo) - Go语言球面几何处理库。

#### 数据分析与可视化
* [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) - 类似于pandas的Go语言数据框架，适用于机器学习和统计分析。
* [gota](https://github.com/go-gota/gota) - Go语言数据框架。
* [gonum/mat](https://godoc.org/gonum.org/v1/gonum/mat) - Go语言线性代数库。
* [gonum/optimize](https://godoc.org/gonum.org/v1/gonum/optimize) - Go语言优化算法实现。
* [gonum/plot](https://godoc.org/gonum.org/v1/plot) - Go语言绘图库。
* [gonum/stat](https://godoc.org/gonum.org/v1/gonum/stat) - Go语言统计库。
* [SVGo](https://github.com/ajstarks/svgo) - Go语言SVG生成库。
* [glot](https://github.com/arafatk/glot) - 基于gnuplot的Go语言绘图库。
* [gonum/graph](https://godoc.org/gonum.org/v1/gonum/graph) - Go语言通用图形库。
* [RF](https://github.com/fxsjy/RF.go) - Go语言随机森林实现（已废弃）。

#### 计算机视觉
* [GoCV](https://github.com/hybridgroup/gocv) - 基于OpenCV 4及以上版本的Go语言计算机视觉库。

#### 强化学习
* [gold](https://github.com/aunum/gold) - Go语言强化学习库。
* [stable-baselines3](https://github.com/DLR-RM/stable-baselines3) - PyTorch实现的强化学习算法库。
...
#### 自然语言处理 (NLP)
- **Cortical.io Retina**: 提供高效的自然语言处理API，能快速执行文本分类、歧义消解等任务。[官网](https://www.cortical.io/)
- **Stanford CoreNLP**: 斯坦福大学提供的自然语言处理工具包，能从英文文本中提取基本单词形式。[官网](https://nlp.stanford.edu/software/corenlp.shtml)
- **Stanford NER**: 斯坦福命名实体识别工具，用于从文本中识别人物、地点等实体。[官网](https://nlp.stanford.edu/software/CRF-NER.shtml)
- **OpenNLP**: 一个基于机器学习的自然语言处理工具包，用于文本处理和标注。[官网](https://opennlp.apache.org/)
- **MALLET**: Java开发的文本处理工具包，支持文档分类、聚类、信息提取等功能。[官网](http://mallet.cs.umass.edu/)
- **LingPipe**: 提供文本处理工具，支持文本分类、命名实体识别等。[官网](http://alias-i.com/lingpipe/index.html)

#### 通用机器学习
- **Weka**: 包含多个机器学习算法，用于数据挖掘任务。[官网](https://www.cs.waikato.ac.nz/ml/weka/)
- **Encog**: 高级神经网络和机器学习框架，支持GPU加速。[官网](https://github.com/encog/encog-java-core)
- **Mahout**: 基于分布式机器学习的工具，支持大规模数据处理。[官网](https://github.com/apache/mahout)
- **Smile**: 提供统计学和机器学习算法的Java工具包。[官网](https://haifengl.github.io/)
- **FlinkML**: Flink上的分布式机器学习库。[官网](https://ci.apache.org/projects/flink/flink-docs-master/dev/libs/ml/index.html)

#### 语音识别
- **CMU Sphinx**: 一个开源的语音识别工具包，纯Java实现。[官网](https://cmusphinx.github.io)

#### 数据分析与可视化
- **Apache Flink**: 分布式流处理和批处理平台。[官网](https://flink.apache.org/)
- **Apache Hadoop**: 用于大数据存储和处理的框架。[官网](https://github.com/apache/hadoop)
- **Apache Spark**: 高效的分布式数据处理引擎，支持大规模数据分析。[官网](https://github.com/apache/spark)
- **Impala**: 适用于Hadoop的大数据实时查询引擎。[官网](https://github.com/cloudera/impala)

#### 深度学习
- **Deeplearning4j**: 支持多GPU并行的深度学习框架，适用于工业级应用。[官网](https://github.com/deeplearning4j/deeplearning4j)
- **Deep Java Library (DJL)**: 一个开源、高层的Java深度学习框架，兼容多种深度学习引擎。[官网](https://github.com/deepjavalibrary/djl)
