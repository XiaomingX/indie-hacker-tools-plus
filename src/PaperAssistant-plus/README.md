...
## 使用示例
假设需要解析论文 `2024_CVPR_Image_Segmentation.pdf`，完整流程如下：
```bash
# 1. 进入项目目录
cd PaperAssistant-plus
...
# 3. 运行工具
python paper_assistant.py --file ./docs/2024_CVPR_Image_Segmentation.pdf

# 4. 查看结果
cat ./docs/2024_CVPR_Image_Segmentation.summary.txt
```
