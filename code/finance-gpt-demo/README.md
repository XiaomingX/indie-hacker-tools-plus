...
### 3. 调用 API 获取投资建议
#### 方式 1：浏览器访问
直接在浏览器输入 URL（替换 `YYYY-MM-DD` 为目标日期，如 `2024-05-20`）：
```
http://127.0.0.1:8000/advice?date=2024-05-20
```

#### 方式 2：命令行（curl）
```bash
curl "http://127.0.0.1:8000/advice?date=2024-05-20"
```
